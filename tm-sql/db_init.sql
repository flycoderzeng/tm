...
CREATE TABLE `auto_cases`  (
                               ...
                               `group_variables` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL,
                               PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 10153 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `case_execute_result_202306`  (
                                               ...
                                               PRIMARY KEY (`id`) USING BTREE,
                                               INDEX `case_result_query_index`(`plan_result_id` ASC) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 4369 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `case_step_execute_result_202306`  (
                                                    ...
                                                    PRIMARY KEY (`id`) USING BTREE,
                                                    INDEX `result_query_index`(`plan_result_id` ASC, `case_id` ASC, `group_no` ASC) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 37622 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `case_variable_value_result_202306`  (
                                                      ...
                                                      `variable_value` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL,
                                                      PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 89662 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `plan_execute_result`  (
                                        ...
                                        PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 2616 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `plan_running_config_snapshot`  (
                                                 ...
                                                 `plan_variables` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL,
                                                 PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 2613 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `platform_api`  (
                                 ...
                                 PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 10032 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 7059 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = Dynamic;
