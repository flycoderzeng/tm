...
public class MockMsgControlService {
    ...
    public void process(ChannelHandlerContext ctx, MockCommunicationMsg<Object> communicationMsg) {
    ...
    private void processPushMockRule(ChannelHandlerContext ctx, MockCommunicationMsg<Object> communicationMsg) {
    ...
    private void processRegisterAckMsg(MockCommunicationMsg<Object> communicationMsg) {
    ...
    public boolean isHeartbeatCheckTimeout() {
        return (System.currentTimeMillis() - lastReceiveHeartbeatAckTimestamp) >
                MockNettyClientInitializer.READER_IDLE_TIME * 3 * 1000;
    }
}
