...
public class GetRandomInt_2 extends GetRandomInt {

    @Override
    public AviatorObject call(Map<String, Object> env, AviatorObject arg1) {
        String ymd = DateUtils.parseTimestampToFormatDate(System.currentTimeMillis(), DateUtils.DATE_PATTERN_YMDHMS);
