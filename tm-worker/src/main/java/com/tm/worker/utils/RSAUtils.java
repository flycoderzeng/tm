...
public class RSAUtils {
    ...
    @PostConstruct()
    public void init() {
        RSAUtils.rsaPrivateKey = privateKey;
        RSAUtils.rsaPublicKey = publicKey;
    }
    ...
    public static String encrypt(String message) {
        return encrypt(RSAUtils.rsaPublicKey, message);
    }

    public static String decrypt(String message) {
        return decrypt(RSAUtils.rsaPrivateKey, message);
    }
